...
function gk_blog_logo() {
	...
	if(get_option($gk_tpl->name . "_branding_logo_type", 'css') == 'image') {
		...
		if(get_option($gk_tpl->name . "_branding_logo_text_type", 'wp') == 'wp') {
			...
			$logo_text = get_option($gk_tpl->name . "_branding_logo_text_value", '') . ' - ' . get_option($gk_tpl->name . "_branding_logo_slogan_value", '');
		}
		...
		if(get_option($gk_tpl->name . "_branding_logo_text_type", 'wp') == 'wp') {
			...
			$logo_text = get_option($gk_tpl->name . "_branding_logo_text_value", '');
