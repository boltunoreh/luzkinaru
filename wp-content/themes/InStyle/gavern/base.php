...
class GavernWP {
	...
	private function gk_read_config() {
	 ...
	 **/
	 ...
	 private function gk_add_actions() {
	 ...
	 **/
	 ...
	 private function gk_add_filters() {
	 ...
	 private function gk_add_features() {
	 	...
	 	// register menus
	 	$this->gk_register_menus();
	 	// register styles
	 	$this->gk_register_styles();
	 	// register fonts
	 	$this->gk_register_fonts();
	 	// add metaboxes
	 	...
	 	register_widget('GK_ImageShow_Widget');
	 }	
	 ...
	 private function gk_register_menus() {
	 ...
	 private function gk_register_styles() {
	 	// load and parse JSON file.
	 ...
	 private function gk_register_fonts() {
	 	// load and parse JSON file.
