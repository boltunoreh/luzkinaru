...
<div id="gk-popup-login" class="gk-popup">	
	<div class="gk-popup-wrap">
		...
		<?php else : ?>
		    <h3><?php _e('Log In', GKTPLNAME); ?> <small><?php _e('or ', GKTPLNAME); ?><a href="<?php echo home_url(); ?>/wp-login.php?action=register" title="<?php _e('Not a member? Register', GKTPLNAME); ?>"><?php _e('Create an account', GKTPLNAME); ?></a></small></h3>
